...
public class Task1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter desired length in bits");
		int n = input.nextInt();
		...
		if (originalNumberSize > n) {
			System.out
					.println("The number you entered is longer then specificied length.");
			System.exit(0);
		...
		if (bin.charAt(0) == '0') {
			System.out
					.println("There is no need to calculating 2'nd complement for entered number, because it is positive.");
		} else {
			...
			System.out.println("Original no is: " + bin);
